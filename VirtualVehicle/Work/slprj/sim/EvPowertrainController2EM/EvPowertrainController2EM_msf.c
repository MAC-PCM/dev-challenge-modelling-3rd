...
rtP__PlntWhlLdRadius2f2PassVeh_sldd_ ; real_T
rtP__Spark_EffMap2f2SparkEM_sldd_ [ 506 ] ; real_T
rtP__Spark_MaxTrq2f2SparkEM_sldd_ [ 29 ] ; real_T
rtP__Spark_MaxTrq_Spd2f2SparkEM_sldd_ [ 29 ] ; real_T
rtP__Spark_Spd_BrkPts2f2SparkEM_sldd_ [ 22 ] ; real_T
...
& ( rtP__PlntWhlLdRadius2f2PassVeh_sldd_ ) , GlobalPrm_14 , sizeof ( real_T )
) ; } if ( ! ssGetModelRefGlobalParamData ( S , 15 , ( void * * ) ( &
GlobalPrm_15 ) ) ) return ; if ( GlobalPrm_15 != NULL ) { ( void ) memcpy ( &
( rtP__Spark_EffMap2f2SparkEM_sldd_ [ 0 ] ) , GlobalPrm_15 , sizeof ( real_T
) * 506 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 16 , ( void * * ) ( &
GlobalPrm_16 ) ) ) return ; if ( GlobalPrm_16 != NULL ) { ( void ) memcpy ( &
( rtP__Spark_MaxTrq2f2SparkEM_sldd_ [ 0 ] ) , GlobalPrm_16 , sizeof ( real_T
) * 29 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 17 , ( void * * ) ( &
GlobalPrm_17 ) ) ) return ; if ( GlobalPrm_17 != NULL ) { ( void ) memcpy ( &
( rtP__Spark_MaxTrq_Spd2f2SparkEM_sldd_ [ 0 ] ) , GlobalPrm_17 , sizeof (
real_T ) * 29 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 18 , ( void * *
) ( & GlobalPrm_18 ) ) ) return ; if ( GlobalPrm_18 != NULL ) { ( void )
memcpy ( & ( rtP__Spark_Spd_BrkPts2f2SparkEM_sldd_ [ 0 ] ) , GlobalPrm_18 ,
sizeof ( real_T ) * 22 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 19 , (
void * * ) ( & GlobalPrm_19 ) ) ) return ; if ( GlobalPrm_19 != NULL ) { (
void ) memcpy ( & ( rtP__Spark_Trq_BrkPts2f2SparkEM_sldd_ [ 0 ] ) ,
GlobalPrm_19 , sizeof ( real_T ) * 23 ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { oaq0dqotmrc * dw = (
oaq0dqotmrc * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_o_B_3_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_o_o_o_B_3_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; real_T * o_o_o_o_B_3_5 = ( real_T * )
ssGetOutputPortSignal ( S , 4 ) ; real_T * o_o_o_o_B_3_6 = ( real_T * )
ssGetOutputPortSignal ( S , 5 ) ; real_T * o_o_o_o_B_3_7 = ( real_T * )
ssGetOutputPortSignal ( S , 6 ) ; cqealxsqr5 ( o_o_o_o_B_3_1 , o_o_o_o_B_3_4
, o_o_o_o_B_3_5 , o_o_o_o_B_3_6 , o_o_o_o_B_3_7 , & ( dw -> rtdw ) ) ; }
static void mdlReset ( SimStruct * S ) { oaq0dqotmrc * dw = ( oaq0dqotmrc * )
ssGetDWork ( S , 0 ) ; real_T * o_o_o_o_B_3_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_o_o_o_B_3_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; real_T * o_o_o_o_B_3_5 = ( real_T * )
ssGetOutputPortSignal ( S , 4 ) ; real_T * o_o_o_o_B_3_6 = ( real_T * )
ssGetOutputPortSignal ( S , 5 ) ; real_T * o_o_o_o_B_3_7 = ( real_T * )
ssGetOutputPortSignal ( S , 6 ) ; pbpffdp5dj ( o_o_o_o_B_3_1 , o_o_o_o_B_3_4
, o_o_o_o_B_3_5 , o_o_o_o_B_3_6 , o_o_o_o_B_3_7 , & ( dw -> rtdw ) ) ; }
...
o_o_o_o_B_3_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T *
o_B_3_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_3_3 = (
real_T * ) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_o_o_o_B_3_4 = (
real_T * ) ssGetOutputPortSignal ( S , 3 ) ; real_T * o_o_o_o_B_3_5 = (
real_T * ) ssGetOutputPortSignal ( S , 4 ) ; real_T * o_o_o_o_B_3_6 = (
real_T * ) ssGetOutputPortSignal ( S , 5 ) ; real_T * o_o_o_o_B_3_7 = (
...
i_j3x4kbjvzk , o_o_o_o_B_3_1 , o_B_3_2 , o_B_3_3 , o_o_o_o_B_3_4 ,
o_o_o_o_B_3_5 , o_o_o_o_B_3_6 , o_o_o_o_B_3_7 , & ( dw -> rtb ) , & ( dw ->
rtdw ) ) ; e3ptmay5nu ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } static
...
slmrInitializeIOPortDataVectors ( S , 9 , 7 ) ; if ( ! ssSetNumInputPorts ( S
...
ssSetInputPortOffsetTime ( S , 8 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 7
...
o_o_o_o_B_3_1 , o_o_o_o_B_3_4 , o_o_o_o_B_3_5 , o_o_o_o_B_3_6 , o_o_o_o_B_3_7
...
real_T * ) ssGetInputPortSignal ( S , 8 ) ; real_T * o_o_o_o_B_3_1 = ( real_T
* ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_3_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_3_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; real_T * o_o_o_o_B_3_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; real_T * o_o_o_o_B_3_5 = ( real_T * )
ssGetOutputPortSignal ( S , 4 ) ; real_T * o_o_o_o_B_3_6 = ( real_T * )
ssGetOutputPortSignal ( S , 5 ) ; real_T * o_o_o_o_B_3_7 = ( real_T * )
ssGetOutputPortSignal ( S , 6 ) ; if ( tid == PARAMETER_TUNING_TID ) {
EvPowertrainController2EMTID1 ( & ( dw -> rtb ) ) ; } if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { EvPowertrainController2EM ( &
( dw -> rtm ) , i_o2wcjkr1jj , i_b52pg0l0et , i_d1xgtlmobm , i_bpogjt4hau ,
i_bspwxb1pui , i_lily4nnzfy , i_k0zxkivegq , i_j3x4kbjvzk , o_o_o_o_B_3_1 ,
o_B_3_2 , o_B_3_3 , o_o_o_o_B_3_4 , o_o_o_o_B_3_5 , o_o_o_o_B_3_6 ,
o_o_o_o_B_3_7 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { oaq0dqotmrc * dw = (
oaq0dqotmrc * ) ssGetDWork ( S , 0 ) ; e3ptmay5nu ( & ( dw -> rtb ) , & ( dw
-> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) {
oaq0dqotmrc * dw = ( oaq0dqotmrc * ) ssGetDWork ( S , 0 ) ; dfeuqru533 ( & (
dw -> rtm ) ) ; return ; }
