...
, - 1 , TARGET_STRING (
 "EvPowertrainController2EM/Energy Management/Powertrain Constraints /EM Constraint Front/Tabular Power Loss Data/2EM Stock/WhlTrq2EMTrq/Unit Delay"
) , TARGET_STRING ( "DSTATE" ) , "" , 0 , 0 , 1 , 0 , 0 , 0 , - 1 , 0 } , { 4
, - 1 , TARGET_STRING (
 "EvPowertrainController2EM/Energy Management/Powertrain Constraints /EM Constraint Rear/Tabular Power Loss Data/2EM Stock/WhlTrq2EMTrq/Unit Delay"
) , TARGET_STRING ( "DSTATE" ) , "" , 0 , 0 , 1 , 0 , 0 , 0 , - 1 , 0 } , { 0
, - 1 , ( NULL ) , ( NULL ) , ( NULL ) , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } }
; static int_T rt_LoggedStateIdxList [ ] = { 2 , 3 , 4 , 0 , 1 } ;
#ifndef HOST_CAPI_BUILD
static void EvPowertrainController2EM_InitializeDataAddr ( void * dataAddr [
] , cpxpfpdja3 * localDW ) { dataAddr [ 0 ] = ( void * ) ( & localDW ->
o5t0xnvnze ) ; dataAddr [ 1 ] = ( void * ) ( & localDW -> f12x4t2yjl ) ;
dataAddr [ 2 ] = ( void * ) ( & localDW -> ow2qkdjqul ) ; dataAddr [ 3 ] = (
void * ) ( & localDW -> gimarahrpl [ 0 ] ) ; dataAddr [ 4 ] = ( void * ) ( &
localDW -> p5p4aaxq51 [ 0 ] ) ; }
#endif
#ifndef HOST_CAPI_BUILD
...
, ( int8_T ) 0 , ( uint8_T ) 0 } } ; static int_T rtContextSystems [ 4 ] ;
static rtwCAPI_LoggingMetaInfo loggingMetaInfo [ ] = { { 0 , 0 , "" , 0 } } ;
static rtwCAPI_ModelMapLoggingStaticInfo mmiStaticInfoLogging = { 4 ,
rtContextSystems , loggingMetaInfo , 0 , ( NULL ) , { 0 , ( NULL ) , ( NULL )
} , 0 , ( NULL ) } ; static rtwCAPI_ModelMappingStaticInfo mmiStatic = { {
rtBlockSignals , 0 , ( NULL ) , 0 , ( NULL ) , 0 } , { ( NULL ) , 0 , ( NULL
) , 0 } , { rtBlockStates , 5 } , { rtDataTypeMap , rtDimensionMap ,
rtFixPtMap , rtElementMap , rtSampleTimeMap , rtDimensionArray } , "float" ,
{ 1320500203U , 1298113070U , 3447829894U , 1931332405U } , &
mmiStaticInfoLogging , 0 , ( boolean_T ) 0 , rt_LoggedStateIdxList } ; const
rtwCAPI_ModelMappingStaticInfo * EvPowertrainController2EM_GetCAPIStaticMap (
...
systemRan [ 3 ] = ( NULL ) ; systemTid [ 1 ] = jcaapsdo3t -> Timing .
mdlref_GlobalTID [ 0 ] ; systemTid [ 2 ] = jcaapsdo3t -> Timing .
mdlref_GlobalTID [ 0 ] ; systemTid [ 3 ] = jcaapsdo3t -> Timing .
