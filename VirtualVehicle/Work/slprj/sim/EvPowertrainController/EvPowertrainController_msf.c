...
GlobalPrm_16 = ( real_T * ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S ,
0 , ( void * * ) ( & GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) {
( void ) memcpy ( & ( rtP__CtrlVcuEvBattChrgPwrMax2f2EvVCU_sldd_ ) ,
GlobalPrm_0 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S
, 1 , ( void * * ) ( & GlobalPrm_1 ) ) ) return ; if ( GlobalPrm_1 != NULL )
{ ( void ) memcpy ( & ( rtP__CtrlVcuEvBattDischrgPwrMax2f2EvVCU_sldd_ ) ,
GlobalPrm_1 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S
, 2 , ( void * * ) ( & GlobalPrm_2 ) ) ) return ; if ( GlobalPrm_2 != NULL )
{ ( void ) memcpy ( & ( rtP__CtrlVcuEvChrgLmtBpt2f2EvVCU_sldd_ [ 0 ] ) ,
GlobalPrm_2 , sizeof ( real_T ) * 11 ) ; } if ( !
ssGetModelRefGlobalParamData ( S , 3 , ( void * * ) ( & GlobalPrm_3 ) ) )
return ; if ( GlobalPrm_3 != NULL ) { ( void ) memcpy ( & (
rtP__CtrlVcuEvDischrgLmtBpt2f2EvVCU_sldd_ [ 0 ] ) , GlobalPrm_3 , sizeof (
real_T ) * 11 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 4 , ( void * *
) ( & GlobalPrm_4 ) ) ) return ; if ( GlobalPrm_4 != NULL ) { ( void ) memcpy
( & ( rtP__CtrlVcuEvRegenBrkCutOff2f2EvVCU_sldd_ [ 0 ] ) , GlobalPrm_4 ,
sizeof ( real_T ) * 2 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 5 , (
void * * ) ( & GlobalPrm_5 ) ) ) return ; if ( GlobalPrm_5 != NULL ) { ( void
) memcpy ( & ( rtP__CtrlVcuEvRegenBrkSpdBpt2f2EvVCU_sldd_ [ 0 ] ) ,
GlobalPrm_5 , sizeof ( real_T ) * 2 ) ; } if ( ! ssGetModelRefGlobalParamData
( S , 6 , ( void * * ) ( & GlobalPrm_6 ) ) ) return ; if ( GlobalPrm_6 !=
NULL ) { ( void ) memcpy ( & ( rtP__CtrlVcuEvSocBpt2f2EvVCU_sldd_ [ 0 ] ) ,
GlobalPrm_6 , sizeof ( real_T ) * 11 ) ; } if ( !
...
& ( rtP__PlntEM1EffTbl2f2ElectricMachine1_sldd_ [ 0 ] ) , GlobalPrm_14 ,
sizeof ( real_T ) * 154 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 15 ,
( void * * ) ( & GlobalPrm_15 ) ) ) return ; if ( GlobalPrm_15 != NULL ) { (
void ) memcpy ( & ( rtP__PlntEM1Trq2f2ElectricMachine1_sldd_ [ 0 ] ) ,
GlobalPrm_15 , sizeof ( real_T ) * 14 ) ; } if ( !
ssGetModelRefGlobalParamData ( S , 16 , ( void * * ) ( & GlobalPrm_16 ) ) )
return ; if ( GlobalPrm_16 != NULL ) { ( void ) memcpy ( & (
rtP__PlntEM1TrqEff2f2ElectricMachine1_sldd_ [ 0 ] ) , GlobalPrm_16 , sizeof (
real_T ) * 11 ) ; } }
#endif
