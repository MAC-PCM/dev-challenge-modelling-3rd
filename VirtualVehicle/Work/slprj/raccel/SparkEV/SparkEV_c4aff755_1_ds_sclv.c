...
int32_T SparkEV_c4aff755_1_ds_sclv ( const NeDynamicSystem * LC , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmBoolVector out ; (
void ) t1 ; ( void ) LC ; out = t2 -> mSCLV ; out . mX [ 0 ] = false ; out .
...
] = false ; out . mX [ 62 ] = false ; out . mX [ 63 ] = false ; out . mX [ 64
] = false ; out . mX [ 65 ] = false ; ( void ) LC ; ( void ) t2 ; return 0 ;
}
